...
const PORT = process.env.PORT || 4000;                                      // On définit le port sur lequel le serveur va écouter les requêtes. Si la variable d'environnement PORT n'est pas définie, il utilisera le port 4000 par défaut.
